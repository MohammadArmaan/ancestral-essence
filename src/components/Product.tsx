...
export default function Product({ product }: ProductProps) {
  ...
  return (
    <Link href={`/products/${product.slug}`} className="h-full border shadow-md rounded-xl bg-card">
      <div className="relative overflow-hidden">
        <WixImage
          ...
          width={700}
          height={700}
          className="transition-transform duration-300 hover:scale-105 bg-white/20 rounded-xl"
        />
